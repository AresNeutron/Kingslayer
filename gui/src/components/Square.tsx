  ...
  return (
    <div
      ...
      style={{
        ...
        ...(bg === "yellow" && {
          background:
            "radial-gradient(circle, hsla(45, 85%, 55%, 0.6) 0%, hsla(45, 85%, 65%, 0.4) 100%)",
          boxShadow: `
        ...
        ...(bg === "blue" && {
          background:
            "radial-gradient(circle, hsla(220, 60%, 35%, 0.5) 0%, hsla(220, 60%, 45%, 0.3) 100%)",
          boxShadow: `
        ...
        ...(bg === "red" && {
          background:
            "radial-gradient(circle, hsla(355, 70%, 45%, 0.6) 0%, hsla(355, 70%, 55%, 0.4) 100%)",
          boxShadow: `
        ...
        ...(bg === "violet" && {
          background:
            "radial-gradient(circle, hsla(280, 50%, 40%, 0.6) 0%, hsla(280, 50%, 50%, 0.4) 100%)",
          boxShadow: `
