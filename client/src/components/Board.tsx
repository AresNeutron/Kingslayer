    ...
    <div className="relative">
      ...
      <div
        className="w-[var(--board-size)] h-[var(--board-size)] grid grid-cols-8 grid-rows-8 
                   ...
                   shadow-inner bg-gradient-to-br from-amber-900 to-amber-800"
        style={{
          boxShadow: `
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `
              radial-gradient(circle at 25% 25%, rgba(139, 38, 53, 0.2) 0%, transparent 50%),
              radial-gradient(circle at 75% 75%, rgba(107, 68, 35, 0.2) 0%, transparent 50%)
            `,
          }}
        />
